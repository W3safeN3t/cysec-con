...
import pic from '../assets/hero-logo.png';
import calendar from '../assets/calendar-icon.png';
import map from '../assets/pin-icon.png';
import ticket from "../assets/ticket-icon.png";

const HeroSection = () => {
  return (
    <div>
      <div className='container mx-auto px-5 py-10 md:p-10 flex flex-col md:flex-row justify-between items-center'>
        <div>
          <h1 className='text-[20px] md:text-[25px] font-medium'>
            <span className='text-[#6B0000]'>SafeNet Society</span> Presents
          </h1>
          <h1 className='font-ElectroHolic text-[40px] md:text-[64px]'>
            CYSEC-CON 2025
          </h1>
          <h1 className='text-[37px] md:text-[64px] font-FiraSans font-bold leading-tight'>
            Mastering Cybersecurity Through <span className='text-[#6B0000]'>Action</span>
          </h1>
          <p className='font-RobotoSerif text-[13px] md:text-[18px] pt-1 pb-3 md:pt-5'>
      ...
      <div className='bg-[#6B0000] text-white py-10 flex flex-col md:flex-row md:items-center justify-between px-10 md:px-20'>
        <div className='flex items-center gap-4 py-5 md:m-0'>
          ...
          <p className='font-RobotoSerif text-[20px]'>TBD</p>
        </div>

        <div className='flex items-center gap-4 py-5 md:m-0'>
          <img src={map} alt="" />
          <div className='font-RobotoSerif text-[20px]'>
