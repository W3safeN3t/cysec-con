...
import shield from '../assets/cysec-shield.png';
import logo from '../assets/cysec-logo.png';
import safenet from '../assets/safenet-logo.png';
...
const Footer = () => {
  return (
    <div className='bg-[#BFC3F2] px-5 py-10 flex flex-col md:flex-row md:items-center justify-evenly'>
      <div className='flex items-center justify-between md:gap-10 pb-8 md:pb-0'>
        <img src={shield} alt="" />
        <img src={logo} alt="" />
        <img src={safenet} alt="" />
      </div>
