...
const Navbar = () => {
  ...
  return (
    <nav className='sticky top-0 z-50 bg-white border-b border-gray-800 py-0 md:py-5 '>
      <div className='container mx-auto flex justify-between items-center px-10'>
        ...
        <div className="hidden md:flex items-center gap-6">
          <ul className="flex items-center gap-8 text-[24px] font-FiraSans font-normal">
            <li>
